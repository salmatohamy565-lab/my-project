...
BEGIN
    ...
    -- 1. First priority: Search for exact Admin/Employee user by username, name, or email
    ...
    ELSE
        -- 2. Second priority: Search general users
        FOR v_candidate IN 
    ...
    -- 3. If still no user matched, auto-register as customer
...
with engine.connect() as conn:
    try:
        ...
        conn.commit()
        print("[SUCCESS] Deployed foolproof Admin/Employee passwordless_login RPC!")
